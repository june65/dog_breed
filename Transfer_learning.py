...
'''    
dir_ = Path('./data/data/')
filepaths = list(dir_.glob(r'**/*.jpg' or r'**/*.jpeg' or r'**/*.png'))
...
train_gen = train_datagen.flow_from_directory('./data/data',
                                                 target_size = (150, 150),
                                                 batch_size = 32,
                                                 class_mode = 'categorical',subset='training')
val_gen  = train_datagen.flow_from_directory('./data/data',
                                                 target_size = (150, 150),
                                                 batch_size = 32,
